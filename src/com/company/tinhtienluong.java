...
/**
 * Created by hang on 9/14/16.
 */
     public class tinhtienluong {
    public static void main(String[] args) {
        Scanner s = new Scanner(System.in);
        System.out.println("muc luong nguoi do nhan duoc la");
        int a = s.nextInt();
        System.out.println("nguoi do xep loai");
        String b = s.nextLine();
        if(b=="A"){
            System.out.println("lương tháng nguoi do la " + a + 3000);

        }if(b=="B"){
            System.out.println("luong thang nv do la " + a +2000 );
        }if(b=="C"){
            System.out.println("luong nv do la " + a + 1000);
        }}}